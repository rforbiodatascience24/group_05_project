...
data_final <- data_clean3 |> 
  select(-`D3 time division (3 light, 3 medium, 3 heavy, and 4 critical)`, -`Antiviral drugs (1 nema 0 no)`, -`Hormones`, -`PCT greater than 0.5`, -`PCT greater than 2`, -`PCT greater than 10`, -`Azvudine`)|> 
  rename("Antiviral Drug" = "Antiviral drugs (1 nema, 2 azides, 3 others)") |> 
  ...
  rename("Administration method" = "Administration method (1 oral and 2 nasal feeding)") |> 
    mutate(`Administration method` = case_when(
    `Administration method` == 1 ~ "Oral feeding",
    `Administration method` == 2 ~ "Nasal Feeding",
    TRUE ~ NA_character_
  )) |> 
  rename("Hormones" = "Hormones (1 methylprednisolone, 2 dexamethasone, 3 others)") |>

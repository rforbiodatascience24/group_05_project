...
tabledat <- tabledat |> 
  mutate(
    ...
    CTSS_score_1 = as.numeric(CTSS_score_1, exclude = NULL),
    CTSS_score_2 = as.numeric(CTSS_score_2, exclude = NULL),
    Fever_days = as.numeric(Fever_days, exclude = NULL),
    `Charlson_index[score]` = as.numeric(`Charlson_index[score]`, exclude = NULL),
...
# Guardar el objeto como imagen PNG
png("table1_describe_01.png", width = 800, height = 600) # Ajusta tamaño según lo necesites
print(table1_describe_01) # Dibuja la tabla en el dispositivo gráfico
...
```{r}
# A change in data augment is needed to do it
```

...
raw_dir <- "../_raw"
raw_file <- file.path(raw_dir, "raw_data.xlsx")
...
download.file(url, raw_file, method = "curl", 
...
# Read the Excel file
#No me fio de que funcione siempre pero me ha ido xd
...
clean_dir <- "../data"
tsv_file <- file.path(clean_dir, "01_dat_load.tsv")
...
#write tsv data
write.table(data_tsv, file = tsv_file, sep = "\t", row.names = FALSE)
```

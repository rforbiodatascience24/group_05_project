...
```{r}
  p1 <- ggplot(data |> filter(Lymphocyte_Test_Day == "D7_lymphocyte_count[10^9/L]"), aes(x = Lymphocyte_Test_Day, y = Lymphocytes, color = `Antiviral_drugs_(1_nema_0_no)`)) +
...
p2 <- ggplot(data |> filter(Lymphocyte_Test_Day == "D7_lymphocyte_count[10^9/L]"), aes(x = Lymphocyte_Test_Day, y = Lymphocytes, color = `Antiviral_drugs_(1_nema_0_no)`)) +

...
if (!dir.exists(raw_dir)) {
  dir.create(raw_dir, recursive = TRUE)  # Create the directory
}
...
# Read the Excel file
#ESTA MIERDA ESTA MAL HAY QUE TOCARLO
xlsx_file <- "../_raw/raw_data.xlsx" 
data_tsv <- read.xlsx(xlsx_file, sheet = 1)
...
if (!dir.exists(clean_dir)) {
  dir.create(clean_dir, recursive = TRUE)  # Create the directory
}
#write tsv data
write.table(data_tsv, file = tsv_file, sep = "\t", row.names = TRUE)

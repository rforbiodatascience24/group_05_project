...
ggplot(symptoms, mapping = aes(fill = Death, x = Symptom)) +
...
ggplot(diseases, mapping = aes(fill = Death, x = Disease)) +
  geom_bar(alpha = .7, color = "black") +
  scale_fill_manual(
    values = c("1" = "#5995ED", "0" = "#DB3069"),
     labels = c(
...
ggplot(ct_data, aes(x = CTSS_score, fill = Death)) +
...
ggplot(mapping = aes(x = `Disease_onset_D1_highest_body_temperature[℃]`, fill = Death)) +
  geom_density(alpha = 0.7) +
  scale_fill_manual(
    values = c("1" = "#5995ED", "0" = "#DB3069"),
    label = c("1" = "Deceased", "0" = "Survived")
